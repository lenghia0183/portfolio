...
const CHIPS: Chip[] = [
  { label: "Shopify", slug: "shopify", bg: "#111111", fg: "#ffffff" },
  { label: "React", slug: "react", bg: "#202020", fg: "#ffffff" },
  { label: "Remix", slug: "remix", bg: "#111111", fg: "#ffffff" },
  { label: "Next.js", slug: "nextdotjs", bg: "#0a0a0a", fg: "#ffffff" },
  { label: "TypeScript", slug: "typescript", bg: "#2F74C0", fg: "#ffffff" },
  { label: "NestJS", slug: "nestjs", bg: "#171717", fg: "#ffffff" },
  { label: "GraphQL", slug: "graphql", bg: "#1f1f1f", fg: "#ffffff" },
  { label: "MySQL", slug: "mysql", bg: "#222222", fg: "#ffffff" },
  { label: "Redis", slug: "redis", bg: "#181818", fg: "#ffffff" },
  { label: "Docker", slug: "docker", bg: "#1f1f1f", fg: "#ffffff" },
  { label: "Claude", slug: "anthropic", bg: "#111111", fg: "#ffffff" },
  { label: "Cursor", slug: "cursor", bg: "#111111", fg: "#ffffff", iconUrl: "https://www.cursor.com/favicon.ico" },
];
